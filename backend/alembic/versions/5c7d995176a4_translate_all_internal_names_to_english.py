...
TABLE_RENAMES: list[tuple[str, str]] = [
    ...
    ("produto_opcao_customizacao", "product_customization_option"),
    ("carrinho", "cart"),
...
COLUMN_RENAMES: dict[str, list[tuple[str, str]]] = {
    ...
    "order_product": [
        ...
        ("nome_produto_snapshot", "product_name_snapshot"),
        ("desconto_percentual_snapshot", "discount_percentage_snapshot"),
...
OLD_INDEXES = [
    ...
    "ix_produto_id_produto",
    "ix_produto_id_admin",
    "ix_produto_deleted_at",
    "ix_imagem_produto_id_imagem",
    "ix_ingrediente_id_ingrediente",
    "ix_produto_opcao_customizacao_id_opcao",
    ...
    "ix_encomenda_produto_id_encomenda_produto",
    "ix_fatura_id_fatura",
...
NEW_INDEXES: list[tuple[str, str, list[str], bool]] = [
    ...
    ("ix_product_image_id_imagem", "product_image", ["id_imagem"], False),
...
def downgrade() -> None:
    ...
    old_indexes: list[tuple[str, str, list[str], bool]] = [
        ...
        ("ix_cliente_email", "cliente", ["email"], True),
        ...
        ("ix_produto_id_produto", "produto", ["id_produto"], False),
        ("ix_produto_id_admin", "produto", ["id_admin"], False),
        ("ix_produto_deleted_at", "produto", ["deleted_at"], False),
        ("ix_imagem_produto_id_imagem", "imagem_produto", ["id_imagem"], False),
        ("ix_ingrediente_id_ingrediente", "ingrediente", ["id_ingrediente"], False),
        ("ix_produto_opcao_customizacao_id_opcao", "produto_opcao_customizacao", ["id_opcao"], False),
        ...
        ("ix_encomenda_produto_id_encomenda_produto", "encomenda_produto", ["id_encomenda_produto"], False),
