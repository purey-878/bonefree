...
INGREDIENT_DEFAULTS: dict[str, tuple[str, Decimal]] = {
    "Americano": ("normal", Decimal("0.02")),
    "Aperol": ("drink", Decimal("1.40")),
    "Bitters": ("drink", Decimal("2.50")),
    "Blue Curação": ("drink", Decimal("3.20")),
    "Cachaça": ("drink", Decimal("2.31")),
    "Café Expresso": ("normal", Decimal("0.02")),
    "Campari": ("drink", Decimal("2.50")),
    "Cappuccino": ("normal", Decimal("0.50")),
    "Club Mate": ("normal", Decimal("0.20")),
    "Esporão Garrafa": ("normal", Decimal("0.85")),
    "Espumante Cinzano": ("drink", Decimal("0.75")),
    "Fritz": ("drink", Decimal("0.42")),
    "Gin": ("drink", Decimal("2.18")),
    "Ginger Ale": ("normal", Decimal("0.34")),
    "Ginger Beer": ("drink", Decimal("0.40")),
    "Grenadina": ("drink", Decimal("2.68")),
    "Ice Tea": ("normal", Decimal("0.30")),
    "Iced Latte": ("normal", Decimal("0.60")),
    "Kombucha": ("normal", Decimal("0.20")),
    "Licor de laranja": ("drink", Decimal("3.20")),
    "Martini Rosso": ("drink", Decimal("1.40")),
    "Rum branco": ("drink", Decimal("2.31")),
    "Rum de côco": ("drink", Decimal("2.50")),
    "Rum escuro": ("drink", Decimal("2.31")),
    "Sangria Jarro 1L": ("normal", Decimal("0.85")),
    "Shot de expresso": ("drink", Decimal("0.02")),
    "Sumo de ananás": ("drink", Decimal("0.53")),
    "Sumo de laranja": ("drink", Decimal("0.45")),
    "Sumo de limão": ("drink", Decimal("0.22")),
    "Sumo do Dia": ("normal", Decimal("0.45")),
    "Tequila": ("drink", Decimal("2.31")),
    "Tia Maria": ("drink", Decimal("3.15")),
    "Tortilha de milho": ("base", Decimal("2.18")),
    "Tortilha de trigo": ("base", Decimal("3.10")),
    "Triple Sec": ("drink", Decimal("3.20")),
    "Vodka": ("drink", Decimal("2.31")),
    "Whisky": ("drink", Decimal("2.50")),
    "Why Not - Refrigerante Artesanal": ("drink", Decimal("0.42")),
    "Xarope de amêndoas": ("drink", Decimal("3.00")),
    "Xarope de morango": ("drink", Decimal("3.00")),
    "Água com gás": ("drink", Decimal("0")),
    "Água das Pedras": ("normal", Decimal("0")),
    "Água de Coco": ("normal", Decimal("0.19")),
}
    ...
    for product_name, quantities in PRODUCT_INGREDIENT_QUANTITIES.items():
        ...
        for ingredient_name, quantity in quantities.items():
            ...
            ingredient_id, ingredient_type, calories_per_gram = get_or_create_ingredient(
                cur,
                ingredient_name,
                fallback_type=default[0] if default else "normal",
            ...
            if existing:
                ...
                cur.execute(
                    ...
                    """,
                    (product_id, ingredient_id, 1 if ingredient_type == "normal" else 0, quantity),
                )
                inserted_links += 1
